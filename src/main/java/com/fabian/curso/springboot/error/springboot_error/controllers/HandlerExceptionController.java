...
import com.fabian.curso.springboot.error.springboot_error.models.Error;
...
public class HandlerExceptionController {
    ...
    public Map<String, Object> numberFormatException(Exception ex) {
        ...
        return error;
    } Ésta opción (declarativa?) no funciona correctamente*/
    ...
    public ResponseEntity<Error> numberFormatException(Exception ex) {
        Error error = new Error();
        error.setDate(new Date());
        error.setError("Número invalido o incorrecto, no tiene formato dígito");
        error.setMessage(ex.getMessage());
        error.setStatus(HttpStatus.INTERNAL_SERVER_ERROR.value());
